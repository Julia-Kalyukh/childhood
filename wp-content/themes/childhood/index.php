  ...
  <div class="glide__track" data-glide-el="track">
    <ul class="glide__slides">
      ...
      $my_posts = get_posts(array(
        'numberposts' => -1, // выводим все слайды
        'category_name'    => 'slider',
        'orderby'     => 'date',
        // 'order'       => 'DESC', // прямой порядок
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-7 offset-1">
                <h2 class="slider__title" style="<?php
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <form action="#" class="contacts__feed">
          ...
          <svg class="confirm ldt-bounce-in" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="38px" height="38px" viewBox="0 0 448.8 448.8" style="enable-background:new 0 0 448.8 448.8; color: green" xml:space="preserve">
            <g>
              <g>
          ...
          <svg class="reject ldt-bounce-in " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="圖層_1" x="0px" y="0px" viewBox="0 0 100 100" style="transform-origin: 50px 50px 0px; width: 40px;" xml:space="preserve">
            <g style="transform-origin: 50px 50px 0px;">
              <g style="transform-origin: 50px 50px 0px; transform: scale(1);">
                <g class="ld ldt-bounce-in" style="transform-origin: 50px 50px 0px; animation-duration: 1.7s; animation-delay: 0s; animation-direction: normal;">
                  <g>
            ...
            <ul class="glide__slides">
              ...
              ?>
                ...
                <li class="glide__slide">
                  <div class="feedslider__title"> <?php the_title(); ?> </div>
                  <div class="feedslider__text"> <?php the_field('feedback_text') ?> </div>
                </li>
              <?php
              }
              wp_reset_postdata();
